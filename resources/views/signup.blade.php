            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="login-card card-block bg-white">
                        <form class="md-float-material" method="post" action="{{route('gonderUser')}}">
                            @csrf
                            ...
                            <div class="md-input-wrapper">
                                <input type="text" name="telefon" class="md-form-control"
                                    required="required"><label>Telefon nömrəsi </label>
                                <span class="md-line"></span>
                            </div>
                            <div class="md-input-wrapper">
                            ...
                            <div class="row">
                                <div class="col-xs-12 text-center">
                                    ...
                                    <a href="{{route('signin')}}" class="f-w-600 p-l-5"> Sign In Here</a>
