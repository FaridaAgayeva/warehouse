            ...
            <div class="row">
                <div class="col-lg-24 table-responsive">
                    <div class="card">
                        ...
                        <h5 class="card-header-text">Müştərilər  <button type="button" id="addNewBook" class="btn btn-success">Add</button></h5>                         </div>
                        <div class="card-block">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="javascript:void(0)" id="addEditClientsForm" name="addEditClientsForm"
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="col-sm-2 control-label">Şirkət</label>
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" id="sirket" name="sirket"
                                                    placeholder="Şirkətinizi daxil edin" maxlength="50" required="">
                                            </div>
                                        </div>
                                        <div class="form-group">
